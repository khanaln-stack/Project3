...
| Verify correct timing behavior for HI, LO, and INT modes. | <ol><li>Calculate expected period based on target rpm and delay times.</li><li>Use stopwatch to measure total time for at least 10 wipe cycles.</li></ol> | <ol><li>Measured periods matched expected timing within reasonable tolerance.</li></ol> |
